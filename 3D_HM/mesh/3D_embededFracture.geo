...
Line(511) = {501, 70};
//+
Line(512) = {70128, 70128};
//+
Line(513) = {70128, 503};
//+
Line(514) = {70136, 70128};
//+
Line(515) = {65, 71};
//+
Line(516) = {70128, 70138};
//+
Line(517) = {71, 500};
//+
Line(518) = {503, 503};
...
Line(519) = {503, 70138};
//+
Curve Loop(502) = {509, 508, -506, 511};
//+
Plane Surface(501) = {502};
//+
Curve Loop(503) = {505, 511, 350, -510};
//+
Plane Surface(502) = {503};
//+
Curve Loop(504) = {504, 510, 514, 513};
//+
Plane Surface(503) = {504};
//+
Curve Loop(505) = {516, -519, -513};
//+
Plane Surface(504) = {505};
//+
Curve Loop(506) = {519, -351, 517, 507};
//+
Plane Surface(505) = {506};
//+
Curve Loop(507) = {517, -508, 515};
//+
Plane Surface(506) = {507};
//+
Curve Loop(508) = {69, -515, -509};
//+
Plane Surface(507) = {508};
//+
Curve Loop(509) = {72, -70, 509, 515, 71};
//+
Plane Surface(508) = {509};
//+
Curve Loop(510) = {514, 516, -349};
//+
Plane Surface(509) = {510};
//+
Curve Loop(511) = {516, 357, 361, -353, 514};
//+
...
//+
Surface Loop(5) = {510, 360, 364, 356, 508, 506, 505, 504, 503, 500, 502, 501};
//+
Volume(5) = {5};
//+
Surface Loop(6) = {507, 352, 501, 506, 505, 504, 503, 500, 502, 509};
//+
Volume(6) = {6};
